 ...
 * 03/07/2017
 * Carrboro HS (NCVPS)
 * Program481s - selection sort
 * 
 * Description: REad and sort a collection of integers using selection sort.
 * What I learned: how to use selection sort techniques.
 * Difficulties: I accidentally sorted them from largest to lowest, but figured it out.
 */
import java.io.*;
import java.util.*;

public class Program481s
{
